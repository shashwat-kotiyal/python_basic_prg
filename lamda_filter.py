...
#map apply the function in each elements of sequence and return modified sequence
# map(function,list)
...
#filter(condition/function,list)
print ("filter greater then 3")
#print (filter(lambda x:if x>3,n))   #
print (filter(lambda x:x>3,n))
